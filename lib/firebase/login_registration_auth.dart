...
//REGISTRATION
 Future<void> signUp(TextEditingController emailContoller,TextEditingController passwordContoller,TextEditingController phoneContoller,TextEditingController nameContoller,BuildContext context) async {
    try {
      // Create user
  ...
  Future<void> addUserDetails(
      String name, int phoneNumber, String? uid) async {
