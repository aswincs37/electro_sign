...
class MobileMyDocumentScreen extends StatefulWidget {
  const MobileMyDocumentScreen({super.key});

  @override
  _MobileMyDocumentScreenState createState() => _MobileMyDocumentScreenState();
}

class _MobileMyDocumentScreenState extends State<MobileMyDocumentScreen> {
                        ...
                        return GestureDetector(
                          onTap: () {
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => ContractSign(
                                    documentUrl: url, docName: name),
                              ),
                            );
